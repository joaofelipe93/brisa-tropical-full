...
export function CartProvider({ children }) {
  ...
  const addItem = (product, quantity = 1, toppings = [], notes = '') => {
    ...
    dispatch({ type: 'ADD_ITEM', item: { product, quantity, toppings, notes, unit_price: price } });
  };
  ...
  return (
    <CartContext.Provider value={{ cart, subtotal, totalItems, addItem, removeItem, updateQty, clearCart }}>
      {children}
