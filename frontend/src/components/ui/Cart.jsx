    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px' }}>
          ...
          <button onClick={onClose} style={{ background: 'var(--gray-100)', border: 'none', borderRadius: '50%', width: 32, height: 32, fontSize: '16px' }}>✕</button>
        </div>
        ...
        {cart.items.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '40px 0', color: 'var(--gray-500)' }}>
            ...
            <p style={{ fontSize: '13px', marginTop: '4px' }}>Adicione itens deliciosos!</p>
          </div>
        ) : (
          <>
                ...
                return (
                  <div key={index} style={{
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <p style={{ fontSize: '14px', fontWeight: '800', color: 'var(--purple-700)', marginTop: '2px' }}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '14px' }}>
                ...
                <span style={{ fontWeight: '800', fontSize: '17px' }}>R$ {subtotal.toFixed(2)}</span>
              </div>
              <button
                onClick={onCheckout}
                style={{
